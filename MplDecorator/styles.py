...
def linestyles(colors=_colors, lines=_lines,
               markers=_markers, hollow_styles=_marker_types, maker_size=0.5):
    """
    Short name for ``linestyle_generator``.
    To be compatible with previous versions.
    """
    return linestyle_generator(colors, lines, markers, hollow_styles, maker_size)
